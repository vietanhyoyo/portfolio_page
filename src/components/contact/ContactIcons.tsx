...
export default function ContactIcons() {
  const renderIcon = (
    ...
    <div className="relative group">
      ...
      <div className="absolute z-10 top-14 left-1/2 transform -translate-x-1/2 bg-gray-700 text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity">
        {href ? (
